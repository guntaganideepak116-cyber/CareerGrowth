  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-95 hover:scale-[1.03]",
  {
    variants: {
      variant: {
        ...
        outline: "border border-input bg-background hover:bg-primary-light hover:text-primary",
        secondary: "bg-secondary text-primary hover:bg-primary-light shadow-sm",
        ...
        ai: "bg-gradient-to-r from-primary to-accent text-primary-foreground shadow-lg hover:shadow-xl hover:shadow-primary/20 font-semibold",
      },
      size: {
