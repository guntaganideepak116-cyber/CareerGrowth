...
export function UserSidebar() {
  ...
  const filteredNavItems = [
    ...
    { icon: MapPin, label: 'Colleges', path: '/colleges' },
  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed top-4 left-4 z-50 p-2 bg-card border border-border rounded-lg shadow-md lg:hidden hover:bg-secondary transition-colors"
      ...
      >
        ...
        <button
          ...
          className="hidden lg:block absolute -right-3 top-20 p-1.5 bg-card border border-border rounded-full shadow-md hover:bg-secondary transition-colors"
